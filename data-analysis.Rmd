...
We can now see clear usage patterns across weekdays and weekends.

# The Ring Road

Even though our data fits in memory, we have a plethora of information. Traffic flow data, even when captured for a couple of cities over two weeks, represents a very complex system with many intricacies that can not be summed up in a few global metrics In this analysis, we will carry out a small practical analysis by isolating the ring road data.
