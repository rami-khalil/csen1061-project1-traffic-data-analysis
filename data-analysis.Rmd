...
Now we can isolate "ba2ollak eh" reports that do not contain any speed information. Furthermore, as the remaining NA values are normally distributed across report_times, and are small relative to the data set, we will discard them.
