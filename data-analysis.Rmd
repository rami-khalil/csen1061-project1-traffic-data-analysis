...
In the spirit of focusing our analyses on single segments or cohesive sets of roads, let us take an excursion into the distribution of travel speeds on the two following 6th of October Bridge road segments:
...
The box plots above convey some interesting information about the distribution of travel speeds across time. For example, people travelling from Ta7rir to Mohandesin on a weekday between 3PM and 7PM exhibit low average travel speeds that are mainly distributed around 25 km/h.

### Weekdays VS Weekends

It is convenient and reasonable to guess from the plots above that weekday and weekend speed distributions are different. Let's try to confirm that assumption using our data.
...
It results from the above two Q-Q plots that for both directions of the 6th of october segment, the weekend measurements and the weekday measurements follow two different distributions and exhibit different tail behavior.
